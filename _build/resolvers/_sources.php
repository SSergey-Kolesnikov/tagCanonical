...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'tagCanonical',
                'description' => 'Default source for files of tagCanonical',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => 'assets/images/tagcanonical/',
                    ),
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'tagcanonical_source_default'))) {
